...
<?php
	...
	<script>
					 ...
					 if (this.value.length > 1) {
						 ...
						 content=$.ajax({ 
									...
									success:function(msg){
										...
										if (result.length>0){
											data ='apakah orang ini yang anda maksud? </br><table class="table  dataTable no-footer">';
											for (var i=0;i<result.length;i++){
												data +="<tr><td>"+(i+1)+"</td><td>"+(result[i]['name_visitor'])+"</td><td>"+(result[i]['company'])+"</td><td>"+(result[i]['domicile'].substring(0,15))+"****</td></tr>";
											}
											data +="</table></br><b style='color:red;'>Jika benar, mohon jangan menambahkan data lagi dikarenakan data sudah ada</b>";
										}
		...
		function getbyktp(){
			...
			var address="http://192.168.137.5:8089/gmkservice/ktpreader/services/bacaChip";

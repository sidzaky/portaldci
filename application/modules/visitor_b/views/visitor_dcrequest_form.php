<div class="row">
									...
									foreach($visitor as $srow){
										...
										echo 	'<tr> 
													...
													<td id="'.$srow['id_visitor'].'">
														...
														'.($srow["organic"]!=0 ? 'PT. Bank Rakyat Indonesia </br> ' : '' ).$srow["company"].' </br>
				...
				<script>
						$("#tablevis").DataTable({ "pageLength": 5, "bLengthChange": false,"bFilter": true,"bInfo": false,"bAutoWidth": false });
						var newRowContent;

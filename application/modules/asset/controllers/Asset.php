...
class Asset extends MX_Controller {
	...
	public function index() {
		if (array_key_exists('asset',$this->session->userdata('module_access'))){		
			$data["asset"] = $this->asset_model->select_all();
			$data['content'] = 'asset_list';
			$data['headboard'] = 'Data Register Seluruh aset M/E GTI dan Sudirman';
			$this->load->view('template',$data);
		}
		else $this->login->noaccess('Asset Module');
	}
	...
	public function add() {
		...
		if($this->input->post()) {
			...
			$location_dc = $this->input->post("location_dc");
		...
		$data["asset_group"] = $this->asset_group_model->select_all();
		$data["dc_location"] = $this->asset_model->get_dc_location();
		
		$data['content']="asset_form";
		$this->load->view("template",$data);
	...
	public function detail($id){
		...
		$data["asset"] = $this->asset_model->select_by_id($id);
		$data["port"] = $this->asset_model->select_port_by_asset_id($id);
		$data["document"] = $this->asset_model->select_document_by_asset_id($id);
		$data["troubleshoot"] = $this->troubleshoot_model->select_by_asset_id($id);
		$data["maintenance"] = $this->maintenance_model->select_by_asset_id($id);
		$data["upcoming"] = $this->upcoming_model->select_by_asset_id($id);
		$data["procurement"] = $this->procurement_model->select_by_asset_id($id);
		
		$data['content'] = 'asset_detail';
		$this->load->view('template',$data);
	...
	public function modify($id){
		...
		$data['content'] = 'asset_form_modify';
		$this->load->view('template',$data);
	}

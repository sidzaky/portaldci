...
<?php 
	...
	echo '
			<form class="form-horizontal form-label-left" method="POST" enctype="multipart/form-data" id="form" action="" novalidate> 
					...
					'.($surat[0]['id_pms_lan']!=null ? '  <input type="hidden" id="id_pms_lan" id="id_pms_lan" value="'.$surat[0]['id_pms_lan'].'">' : '' ).'
					'.($surat[0]['document_SIK']!=null ? '  <input type="hidden" id="document_SIK_ex"  value="'.$surat[0]['document_SIK'].'">' : '' ).'
					'.($surat[0]['status_SIK']!=null ? ' <input type="hidden" id="status_SIK" value="'.$surat[0]['status_SIK'].'"> <input type="hidden" id="update_status_SIK" value="'.$surat[0]['update_status_SIK'].'"><input type="hidden" id="user_set_status_SIK" value="'.$surat[0]['user_set_status_SIK'].'">' : '').'
							...
							<div class="item form-group">
								<label class="control-label col-md-2 col-sm-3 col-xs-3" for="hostname">
									<i>Jenis Tarikan</i> <span class="required">*</span>
								</label>
								<label class="control-label col-md-2 col-sm-3 col-xs-3" for="hostname">
									<i>Jumlah Tarikan</i> <span class="required">*</span>
								</label>
								<label class="control-label col-md-2 col-sm-3 col-xs-3" for="hostname">
									<i>Titik Pertama</i> <span class="required">*</span>
								</label>
								<label class="control-label col-md-2 col-sm-3 col-xs-3" for="hostname">
									<i>Titik Kedua</i> <span class="required">*</span>
								</label>
								<label class="control-label col-md-2 col-sm-3 col-xs-3" for="hostname">
									<i>Keterangan</i> <span class="required">*</span>
								</label>
							</div><div class="item form-group" id="tarikan">';
							...
							if ($tarikan!=null) {
								...
								foreach ($tarikan as $row){
									$i++;
									echo '
										<div id="tarikan_'.$i.'" name="tarikan_'.$i.'" class="formtarikan">
											<div class="col-md-2 col-sm-2 col-xs-12">
												<select '.$disabled.' class="form-control col-md-7 col-xs-12" id="jenis_tarikan_'.$i.'" name="jenis_tarikan_'.$i.'">
													<option value="Kabel Data" '.($row->jenis_pms_lan=='Kabel Data' ? 'selected' : '' ).' >Kabel Data</option>
													<option value="Kabel Power" '.($row->jenis_pms_lan=='Kabel Power' ? 'selected' : '' ).'>Kabel Power</option>
													<option value="Power Ekstension" '.($row->jenis_pms_lan=='Power Ekstension' ? 'selected' : '' ).'>Power Ekstension</option>
													<option value="Patch Cord" '.($row->jenis_pms_lan=='Patch Cord' ? 'selected' : '' ).'>Patch Cord</option>
													<option value="PDU" '.($row->jenis_pms_lan=='PDU' ? 'selected' : '' ).'>PDU</option>
													<option value="Connector Power" '.($row->jenis_pms_lan=='Connector Power' ? 'selected' : '' ).'>Connector Power</option>
													<option value="Fiber Optic" '.($row->jenis_pms_lan=='Fiber Optic' ? 'selected' : '' ).'>Fiber Optic</option>
													<option value="FO 4core" '.($row->jenis_pms_lan=='FO 4core' ? 'selected' : '' ).'>FO 4core</option>
													<option value="FO 2core" '.($row->jenis_pms_lan=='FO 2core' ? 'selected' : '' ).'>FO 2core</option>
													<option value="CCTV" '.($row->jenis_pms_lan=='' ? 'CCTV' : '' ).'>CCTV</option>
													<option value="Telepon" '.($row->jenis_pms_lan=='Telepon' ? 'selected' : '' ).'>Telepon</option>
													<option value="Lain lain" '.($row->jenis_pms_lan=='Lain lain' ? 'selected' : '' ).'>Lain lain</option>
												</select>
											</div>
											<div class="col-md-2 col-sm-2 col-xs-12">
											  <input type="number" '.$disabled.'  value="'.$row->jumlah_pms_lan.'" id="jumlah_tarikan_'.$i.'" name="jumlah_tarikan_'.$i.'" class="form-control col-md-7 col-xs-12" placeholder="">
											</div>
											<div class="col-md-2 col-sm-2 col-xs-12">
											  <input type="text" '.$disabled.' value="'.$row->titik_pertama.'" id="titik_pertama_tarikan_'.$i.'" name="titik_pertama_tarikan_'.$i.'" class="form-control col-md-7 col-xs-12" placeholder="">
											</div>
											<div class="col-md-2 col-sm-2 col-xs-12">
											  <input type="text" '.$disabled.' value="'.$row->titik_kedua.'" id="titik_kedua_tarikan_'.$i.'" name="titik_kedua_tarikan_'.$i.'" class="form-control col-md-7 col-xs-12" placeholder="">
											</div>
											
											<div class="col-md-3 col-sm-3 col-xs-12">
											  <input type="text" '.$disabled.' value="'.$row->keterangan.'" id="keterangan_'.$i.'" name="keterangan_'.$i.'" class="form-control col-md-7 col-xs-12" placeholder="">
											</div>
											
											<div class="col-md-1 col-sm-1 col-xs-12">
												'.($i==1 ? ' <button '.$disabled.' onclick="formact(1)" type="button" class="btn btn-default btn-sm"><i class="fa fa-plus"></i></button>' : ' <button '.$disabled.'  onclick="minform('.$i.')" type="button" class="btn btn-default btn-sm"><i class="fa fa-minus"></i></button>').'
											</div>
										</div>
									';	
								}
								...
								echo '<div id="tarikan_1" name="tarikan_1" class="formtarikan">
											<div class="col-md-2 col-sm-2 col-xs-12">
												<select  '.$disabled.' class="form-control col-md-7 col-xs-12" id="jenis_tarikan_1" name="jenis_tarikan_1">
													<option value="Kabel Data">Kabel Data</option>
													<option value="Kabel Power">Kabel Power</option>
													<option value="Power Ekstension">Power Ekstension</option>
													<option value="Patch Cord">Patch Cord</option>
													<option value="PDU">PDU</option>
													<option value="Connector Power">Connector Power</option>
											...
											<div class="col-md-2 col-sm-2 col-xs-12">
											  <input type="number" id="jumlah_tarikan_1" name="jumlah_tarikan_1" class="form-control col-md-7 col-xs-12" placeholder="">
											</div>
											<div class="col-md-2 col-sm-2 col-xs-12">
											  <input type="text" id="titik_pertama_tarikan_1" name="titik_pertama_tarikan_1" class="form-control col-md-7 col-xs-12" placeholder="">
											</div>
											<div class="col-md-2 col-sm-2 col-xs-12">
											  <input type="text" id="titik_kedua_tarikan_1" name="titik_kedua_tarikan_1" class="form-control col-md-7 col-xs-12" placeholder="">
											</div>	
											<div class="col-md-3 col-sm-3 col-xs-12">
											  <input type="text" id="keterangan_1" name="keterangan_1" class="form-control col-md-7 col-xs-12" placeholder="">
											</div>
											<div class="col-md-1 col-sm-1 col-xs-12">
											   <button onclick="formact(1)" type="button" class="btn btn-default btn-sm"><i class="fa fa-plus"></i></button>
											</div>
										</div>
									</div>';
							}

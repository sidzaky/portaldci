...
class Maintenancenonme extends MX_Controller {
	...
	public function __construct() {
		...
		$this->load->model('maintenancenonme_m','maintenance_m');
		$data['breadcrumb'][0] = 'Portal Isd';
		$data['breadcrumb'][1] = 'Maintenance Non M/E Module';
		$data['headboard'] = 'Data Maintenance Non M/E Asset ';
		$data['navbar'] = 'navbar';

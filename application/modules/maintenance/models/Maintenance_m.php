...
class maintenance_m extends CI_Model 
{
	...
	public function select_all() {
                $sql = "SELECT distinct(A.ID), A.* , B.HOSTNAME FROM asset_maintenance A 
				...
				$sql .= " GROUP BY A.ID order by A.TIME_INPUT desc"; 
        ...
        public function input_maintenance_m(){
				...
				$this->activity_m->writelog('Maintenance',"new maintenance input");
				return true;
        }

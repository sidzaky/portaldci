	...
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="row">
			<div class="white-box">
				...
				<div id="item-list">
					<div class="x_content">
						<form  class="form-horizontal form-material" method="POST" enctype="multipart/form-data"  id="form" action="<?php echo base_url("inventory/add"); ?>" validate>
								...
								<div class="col-md-12">
									<div class="item form-group">
										...
										<div class="col-md-6 col-sm-6 col-xs-12">
										  <input type="text"name="jenis" id="jenis" class="form-control col-md-7 col-xs-12" required="required">
										</div>
									</div> 
									<div class="item form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Tipe Perangkat</label>
										<div class="col-md-6 col-sm-6 col-xs-12">
										  <input type="text" name="tipe" id="tipe" class="form-control col-md-7 col-xs-12" required="required">
										</div>
									</div>
									<div class="item form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Serial Number</label>
										<div class="col-md-6 col-sm-6 col-xs-12">
										  <input type="text" name="sn" id="sn" class="form-control col-md-7 col-xs-12" required="required">
										</div>
									</div>
									<div class="item form-group">
										...
										<div class="col-md-6 col-sm-6 col-xs-12">
										  <input type="date" id="tgl_masuk" name="tgl_masuk"  class="form-control col-md-4 col-xs-8" >
									...
									<div class="item form-group">
										...
										<div class="col-md-6 col-sm-6 col-xs-12">
										  <input type="text" name="pemilik" id="pemilik" class="form-control col-md-7 col-xs-12" required="required">
										</div>
									</div>
									<div class="item form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Koordinat Perangkat</label>
										<div class="col-md-6 col-sm-6 col-xs-12">
										  <input type="text" name="koordinat" id="koordinat" class="form-control col-md-7 col-xs-12" required="required">
										</div>
									</div>
									<div class="item form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Nomor Unit (dalam rak)</label>
										<div class="col-md-6 col-sm-6 col-xs-12">
										  <input type="text" name="no_unit" id="no_unit" class="form-control col-md-7 col-xs-12" required="required">
										</div>
									</div>
									<div class="item form-group">
